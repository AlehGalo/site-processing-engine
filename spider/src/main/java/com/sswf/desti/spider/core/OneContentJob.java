...
import static com.sswf.desti.spider.core.SpiderUtil.getUrlsOfTheSameDomain;
import static com.sswf.desti.spider.core.extractor.deprecation.DeprecationFactory.createDeprecationRules;
...
import com.sswf.desti.spider.core.extractor.DepthOfHref;
import com.sswf.desti.spider.core.extractor.LinksExtractor;
...
class OneContentJob implements IObserverable<IContent> {
    ...
    public OneContentJob(final Statistics stat, final AtomicInteger pagesScanned, final String host,
            final IObserverable<IContent> obs, final IURLCoordinator<IContent> urlCoordinator,
            final Set<IContent> setOfNotDomainedUrls) {
    ...
    private void applyDownloadedFile(File file, IContent url) {
        if (file == null) {
            return;
        }
    ...
    private void tryProcessDownloadedFile(File file, IContent url) throws IOException {
    ...
    private LinksExtractor createLinksExtractor(String currentPageUrl) {
