...
public class SwaggerConfiguration implements EnvironmentAware {
    ...
    public static final String SWAGGER_GROUP = "informer-api";
    ...
    /**
     * The ApiListingReferenceScanner does most of the work. Scans the
     * appropriate spring RequestMappingHandlerMappings Applies the correct
     * absolute paths to the generated swagger resources
     */
    @Bean
    ...
    public ApiPathProvider apiPathProvider() {
        ApiPathProvider apiPathProvider = new ApiPathProvider(
                propertyResolver.getProperty("apiDocsLocation"));
