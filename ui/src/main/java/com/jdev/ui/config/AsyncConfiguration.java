...
import com.jdev.ui.async.ExceptionHandlingAsyncTaskExecutor;
...
public class AsyncConfiguration implements AsyncConfigurer, EnvironmentAware {
    ...
    public Executor getAsyncExecutor() {
        ...
        executor.setQueueCapacity(propertyResolver.getProperty("queueCapacity", Integer.class,
                10000));
        executor.setThreadNamePrefix("informer-Executor-");
