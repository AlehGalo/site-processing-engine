 ...
 * 
 */
public class HeaderEntityContentTypeSelector extends EntitySelector {

    /**
     * @param unit
     */
    public HeaderEntityContentTypeSelector(final ISelectUnit unit) {
        super(unit);
    }
    ...
    public Collection<ISelectorResult> select(final HttpEntity content) throws SelectionException {
        ...
        Header header = content.getContentType();
        if (header != null) {
